...
### Classification
Domains: Market
Target File: domains/market/esm_security_requirements.md (New)
...
### Index Update
- [Security ESM Requirements](esm_security_requirements.md): Market analysis of the Security vertical, covering physical access, incident reporting, and strict confidentiality protocols.

...
### Classification
Domains: Market
Target File: domains/market/esm_facilities_requirements.md (New)
...
### Index Update
- [Facilities ESM Requirements](esm_facilities_requirements.md): Market analysis of the Facilities Management vertical, including work order needs, field service requirements, and key integrations.

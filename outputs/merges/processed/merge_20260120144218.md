...
### Classification
Domains: Market
Target File: domains/market/esm_hr_requirements.md (New)
...
- [HR ESM Requirements](esm_hr_requirements.md): Market analysis of the HR Service Desk vertical, covering employee lifecycle, PII security, and HRIS integrations.
